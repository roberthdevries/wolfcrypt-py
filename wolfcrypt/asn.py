...
if _lib.RSA_ENABLED:
    from wolfcrypt.ciphers import RsaPrivate, RsaPublic  # ty: ignore[possibly-missing-import]
if _lib.SHA_ENABLED:
...
if _lib.ASN_ENABLED:
    ...
    def make_signature(data: bytes, hash_cls: type[_Hash], key: RsaPrivate | None = None) -> bytes:
        hash_obj = hash_cls()
    ...
    def check_signature(signature: bytes, data: bytes, hash_cls: type[_Hash], pub_key: RsaPublic) -> bool:
